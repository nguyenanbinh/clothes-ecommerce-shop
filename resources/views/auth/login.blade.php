                            ...
                            <div class="tab-pane fade show active" id="pills-homes" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_input justify-content-center">
                                            @if ($errors->has('email'))
                            ...
                            <div class="tab-pane fade" id="pills-profiles" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-user-tie"></i>
                                            <input id="reg_name" name="reg_name" value="{{old('name')}}" type="text"
                                                   placeholder="Name">
                                            @if ($errors->has('reg_name'))
                                                <code>{{$errors->first('reg_name')}}</code>
                                            @endif
                                        </div>

                                        <div class="wsus__login_input">
                                            <i class="far fa-envelope"></i>
                                            <input id="reg_email" type="email" name="reg_email" value="{{old('email')}}"
                                                   type="text" placeholder="Email">
                                            @if ($errors->has('reg_email'))
                                                <code>{{$errors->first('reg_email')}}</code>
                                            @endif
                                        </div>
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            @if ($errors->has('reg_password'))
                                                <code>{{$errors->first('reg_password')}}</code>
                                            @endif
                                        </div>
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input id="reg_password_confirmation" type="password"
                                                   name="reg_password_confirmation" placeholder="Confirm Password">
                                            @if ($errors->has('reg_password_confirmation'))
                                                <code>{{$errors->first('reg_password_confirmation')}}</code>
                                            @endif
                                        </div>
