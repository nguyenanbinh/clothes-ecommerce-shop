...
@php
    $tempFlashSaleDate = $flashSaleDate->end_date ?? Carbon\Carbon::now()->addMonth();
@endphp
@push('scripts')
    <script>
        $(document).ready(function(){
            simplyCountdown('.simply-countdown-one', {
                year: {{date('Y', strtotime($tempFlashSaleDate))}},
                month: {{date('m', strtotime($tempFlashSaleDate))}},
                day: {{date('d', strtotime($tempFlashSaleDate))}},
            });
        });
    </script>
@endpush
